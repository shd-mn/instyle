                ...
                <div className={styles['tab-content']}>
                    {activeTab === 0 && (
                        <div className={styles.desc}>
                            <p>
                                Miss Selfridge takes you from day to date night
                                with its off-duty looks and full-on glamour.
                                Solve what-to-wear dilemmas with its dresses and
                                accessories that combine inherent femininity and
